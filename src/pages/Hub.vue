		...
		<q-dialog v-model="uploadDial" :maximized="maximizedUploadToggle" transition-show="fade" transition-hide="fade" >
			<q-card style=" max-width: 100vw;">
				...
				<q-card-section>
					...
					<div class="text-h6 text-blue-grey-8">Or use <a href="https://github.com/gguibon/ezcat/tree/main/public/dummy_files" target="_blank">dummy files</a> to test the app</div>
				</q-card-section>
